...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set response ID in hidden field
    document.getElementById('responseId').value = patientData.responseId;
    ...
    document.getElementById('consentForm').addEventListener('submit', async function(e) {
        ...
        if (!document.getElementById('privacy_acknowledgment').checked) {
